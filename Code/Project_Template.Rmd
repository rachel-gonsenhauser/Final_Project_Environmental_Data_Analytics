...
```{r figs9, echo = FALSE, warnings=FALSE, messages=FALSE, fig.height = 4, fig.width = 10, fig.cap="North Carolina Arsenic Concentrations by Trihalomethane Concentration."}
...
```{r figs10, echo = FALSE, warnings=FALSE, messages=FALSE, fig.height = 4, fig.width = 10, fig.cap="North Carolina Arsenic Concentrations by Population Served by CWS Across Income Levels."}
...
```{r figs12, echo = FALSE, warnings=FALSE, messages=FALSE, fig.height = 4, fig.width = 10, fig.cap="Massachusetts Arsenic Concentrations by Population Served by CWS Across Income Levels."}
...
```{r figs13, echo = FALSE, warnings=FALSE, messages=FALSE, fig.height = 4, fig.width = 10, fig.cap="PFAS Concentration by Population Served by CWS Across Income Levels."}
