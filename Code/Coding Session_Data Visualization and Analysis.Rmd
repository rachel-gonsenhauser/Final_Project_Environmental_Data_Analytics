...
# Preliminary plot, not a great plot...maybe not worth showing...? something else
...
PFAS.plot <- ggplot(PFAS.data, aes(x = Population.Served, y = PFAS_ppt, color = State)) +
  geom_point() +
  xlim(39860, 98312) 
print(PFAS.plot)
